...
python3 "${DNLOAD}" -v src/main.cpp -o kerava --rand=gnu -DVGL_DISABLE_CEIL -DVGL_DISABLE_DEPTH_TEXTURE -DVGL_DISABLE_EDGE -DVGL_DISABLE_OGG -DVGL_DISABLE_POLYGON_OFFSET -DVGL_DISABLE_STENCIL -DVGL_USE_BONE_STATE_FULL_TRANSFORM $*
if [ $? -ne 0 ] ; then
