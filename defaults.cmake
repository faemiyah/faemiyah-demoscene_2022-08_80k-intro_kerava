...
function(find_flac)
    if(MSVC)
        ...
        check_link_directory_msvc("flac-" "objs")
        set(FLAC_LIBRARY_DEBUG "debug/lib/libFLAC_static" PARENT_SCOPE)
        set(FLAC_LIBRARY "release/lib/libFLAC_static" PARENT_SCOPE)
...
function(find_glew)
    ...
    if(MSVC)
        ...
        check_link_directory_msvc("${DIR}glew-" "lib/Debug/Win32")
        check_link_directory_msvc("${DIR}glew-" "lib/Release/Win32")
...
function(find_ogg)
    if(MSVC)
        ...
        check_link_directory_msvc("libogg-" "win32/VS2015/Win32")
        set(OGG_LIBRARY_DEBUG "Debug/libogg" PARENT_SCOPE)
        set(OGG_LIBRARY "Release/libogg" PARENT_SCOPE)
    else()
        include(FindPkgConfig)
...
function(find_opus)
    if(MSVC)
        ...
        check_link_directory_msvc("opus-" "win32/VS2015/Win32")
...
function(find_png)
    ...
    if(MSVC)
        ...
        check_link_directory_msvc("${DIR}libpng-" "projects/vstudio")
